...
public class Drawer3Adapter extends BaseRecyclerAdapter<DrawerChildThemeDtoModel, RecyclerView.ViewHolder> {
...
//        list.add(new DrawerChildThemeDtoModel().setId(i++).setTitle("ثبت ملک جدید").setDrawableIcon(R.drawable.add));
        ...
        list.add(new DrawerChildThemeDtoModel().setId(i++).setTitle("درخواست های من").setDrawableIcon(R.drawable.order));
